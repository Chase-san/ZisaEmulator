...
#define SPI_REG_RAM_A 8
#define SPI_REG_RAM_B 9
#define SPI_REG_RAM_C 10
#define SPI_REG_RAM_D 11
#define SPI_REG_RAM_E 12
#define SPI_REG_RAM_F 13
#define SPI_REG_RAM_G 14
#define SPI_REG_RAM_H 15
...
static inline int zvb_tf_is_write(zvb_tf_state_t st) {
    return st == TF_WRITE_BLOCK_WAIT_TOK || st == TF_WRITE_BLOCK || st == TF_WRITE_BLOCK_SEND_RESP;
}
